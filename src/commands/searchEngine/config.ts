...
export const Commands: SearchableCommand[] = [
  ...
  },
  {
    ...
    name: "刷新文件分析缓存",
    tags: ["重新分析文件信息，以正确更新其他命令的搜索结果"]
  },
  {
    id: "LeAppPlugin.startTrackCodeServer",
    name: "打开代码追踪器",
    tags: ["开发时通过UI快速定位文件位置"]
  },
  {
    id: "LeAppPlugin.StartLeReactCoder",
    name: "打开辅助编码器",
    tags: ["获得设计稿后，把index.html拖入编辑器后，打开辅助编码器快速编程"]
  },
  {
    id: "LeAppPlugin.openExternalAdmin",
    name: "打开项目管理后台",
    tags: ["ABTest查询", "图标资源查询", "需要sam启动该服务"]
  },
  {
...
export const HelpCommands: SearchableCommand[] = [
  ...
  {
    id: "LeAppPlugin.checkSpeechRecognitionCommands",
    name: "查看语音命令列表",
    tags: ["语音识别"]
  }
];
